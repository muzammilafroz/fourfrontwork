...
const Landing = () => {
  ...
  const dashPath = user?.role === 'owner' ? '/owner/overview' : user?.role === 'employee' ? '/employee/medicines' : '/customer/doctors';
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">A comprehensive pharmacy ecosystem designed for customers, employees, and owners.</p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">Three simple steps to get started with MedEase.</p>
          </div>
      ...
      <footer className="border-t border-border py-8 bg-card">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-sm text-muted-foreground">Smart Pharmacy & Doctor Consultation System</p>
        </div>
      </footer>
    </div>
  );
