...
const API_MEDS = `${API_BASE}/api/medicines`;
...
const CreateOrder = () => {
  ...
  const loadRecentOrders = async () => {
    ...
    try {
      ...
      setFilteredOrders(Array.isArray(formattedOrders) ? formattedOrders : []);
    } catch (error) {
  ...
  const addItem = (medId: string) => {
    ...
    const existingItem = items.find((i) => i.id === med.id);
    if (existingItem) {
  ...
  const removeItem = (idx: number) => {
    ...
    toast.info(`${item.medicine.name} removed from order`);
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const formattedOrder = formatOrders(data);
      console.log(formattedOrder);

      toast.success("Order created successfully!");
      setSelectedBill(formattedOrder);
                            ...
                            <div className="flex justify-between items-start">
                              <div>
                                ...
                                <p className="text-xs text-muted-foreground mt-0.5">
                                  {m.brand} • Stock: {m.stock_quantity}
                                </p>
                              </div>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="relative flex-1">
                    ...
                    <Input
                      ...
                      step={discount.type === "percentage" ? 5 : 10}
              ...
              <div className="bg-white rounded-lg p-4 print:p-0 text-sm">
                <div className="flex justify-between items-start border-b border-gray-200 pb-2 mb-2">
                  ...
                  <div className="text-right text-[10px] text-gray-500">
                    <p>
                      {new Date(selectedBill.order_date).toLocaleDateString()}
                    </p>
                  </div>
                </div>
                ...
                <table className="w-full mb-2 text-[11px]">
                  <thead>
                    <tr className="border-t border-b border-gray-200 bg-gray-50">
                      ...
                      <th className="py-1 text-center font-medium text-gray-600">
                        Qty
                      </th>
