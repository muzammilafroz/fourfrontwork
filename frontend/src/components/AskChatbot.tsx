          ...
          {!hasMessages && !loading && (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1 max-w-md">
                Ask me anything about medicines, symptoms, dosage, or general
                health questions.
              </p>
        ...
        <div className="pt-4 border-t border-border">
          <div className="flex gap-2">
            <Input
              ...
              placeholder={
                loading ? "Chatbot is thinking..." : "Ask Chatbot anything..."
              }
              disabled={loading}
          ...
          <p className="text-xs text-muted-foreground text-center mt-3">
            <span className="font-bold">Notice:</span> For informational
            purposes only. Always consult a doctor for medical advice.
          </p>
        </div>
      </div>
        ...
        <DialogContent className="sm:max-w-sm">
          ...
          <DialogFooter className="gap-2 mt-2">
            ...
            <Button
              variant="destructive"
              onClick={() =>
                showDeleteConfirm && deleteSession(showDeleteConfirm)
              }
