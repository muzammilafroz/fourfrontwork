...
class TestCart:
    """Test cases for /api/cart endpoints"""

    def test_get_cart_items_authenticated(
    ...
    def test_get_cart_item_by_id(
        ...
        response = client.get(
            f"/api/cart/{cart_item.id}", headers=auth_headers_customer
        )
        assert response.status_code == 200
    ...
    def test_get_cart_item_not_found(self, client: TestClient, auth_headers_customer):
        ...
        response = client.get("/api/cart/99999", headers=auth_headers_customer)
    ...
    def test_create_cart_item_order_not_found(
        self, client: TestClient, auth_headers_customer
    ):
    ...
    def test_create_cart_item_unauthorized(
